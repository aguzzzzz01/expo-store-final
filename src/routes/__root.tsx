...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A deployment application for managing and automating software releases." },
      { property: "og:description", content: "A deployment application for managing and automating software releases." },
      { name: "twitter:description", content: "A deployment application for managing and automating software releases." },
